...
#google data that has keywords but no content tag
keywords_no_content = pd.read_csv('~/Desktop/Google_Analytics_2020/Keywords_No_Content/Actual_Keywords_NoAdContent_Analytics HBG+Imprint_ Forever Full  View 2020 20200101-20201231-1.csv', skiprows=6)
...
#drop colums Date Range and Ad Content
...
#merginging keywords_matching with keywords_no_content_new
...
##MOVE THIS AFTER THE NEXT ROUND
